import { CheckedValue } from "../Types/types.js";

export function checkName(name: string): CheckedValue {
  if (name === "") return ["error", "Type your name please."];
  return name;
}

export function checkLName(lName: string): CheckedValue {
  if (lName === "") return ["error", "Type your last name please"];
  return lName;
}

export function checkEmail(email: string): CheckedValue {
  const re = /\S+@\S+\.\S+/;
...
export function checkPassword(password: string): CheckedValue {
...
export function checkLegality(dOb: string): CheckedValue {
...
export function checkGender(gender: string): CheckedValue {
  if (!gender) return ["error", "Pick your gender."];
  return gender;
}

export function checkMobile(mobile: string): CheckedValue {
...
export function checkAdress(adress: string): CheckedValue {
